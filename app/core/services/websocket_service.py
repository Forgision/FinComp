...
def get_websocket_connection(
    username: str,
) -> Tuple[bool, Optional[WebSocketClient], Optional[str]]:
    """
...
def get_websocket_status(
    username: str, broker: Optional[str] = None
...
def get_websocket_subscriptions(
    ...
    try:
        ...
        if not success:
            return (
                False,
                {"status": "error", "message": error, "subscriptions": []},
                200,
            )
...
def get_supported_brokers_list() -> Tuple[bool, Dict[str, Any], int]:
    ...
    try:
        ...
        ws_brokers = [
            ...
            if broker in websocket_enabled_brokers
        ]
...
def get_market_data(
    username: str, symbol: Optional[str] = None, exchange: Optional[str] = None
) -> Tuple[bool, Dict[str, Any], int]:
    """
    ...
    try:
        ...
        return (
            True,
            {"status": "success", "data": market_data, "timestamp": int(time.time())},
            200,
        )
