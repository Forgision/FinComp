...
from app.core.models.token_db import load_cache_for_broker
from app.core.models.token_db_enhanced import get_cache, get_cache_stats
...
def clear_cache_on_logout():
    ...
    """
    try:
        from app.core.models.token_db_enhanced import clear_cache, get_cache_stats
...
def get_cache_health() -> dict:
    ...
    """
    try:
        from app.core.models.token_db_enhanced import get_cache_stats
