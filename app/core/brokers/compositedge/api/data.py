...
from app.core.brokers.compositedge.baseurl import MARKET_DATA_URL
from app.core.brokers.compositedge.database.master_contract_db import SymToken
...
class BrokerData:
    ...
    def _get_instrument_token(self, symbol: str, exchange: str) -> tuple:
        ...
        symbol_info = db.scalars(stmt).first()
    ...
    def get_market_depth(self, symbol: str, exchange: str) -> dict:
        ...
        try:
            ...
            if (
                not user_id
                and hasattr(db, "marketdata_userid")
                and db.get("marketdata_userid")
            ):
                user_id = db.get("marketdata_userid")
            ...
            if (
                not feed_token
                and hasattr(db, "marketdata_token")
                and db.get("marketdata_token")
            ):
                feed_token = db.get("marketdata_token")
