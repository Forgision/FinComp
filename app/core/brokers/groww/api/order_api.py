...
from app.core.brokers.groww.database.master_contract_db import (
    format_openalgo_to_groww_symbol,
)
from app.core.brokers.groww.mapping.transform_data import (
    # Constants
    EXCHANGE_NSE,
    ORDER_TYPE_LIMIT,
    ORDER_TYPE_MARKET,
                        ...
                        for position in fno_positions:
                            ...
                            if (
                                ...
                                try:
                                    ...
                                    try:
                                        from app.core.schemas.token_db import (
                                            get_oa_symbol,
                                        )
                                    except ImportError:
                                        from ....db.models.token_db import get_oa_symbol
...
def direct_place_order_api(data, auth):
    ...
    try:
        ...
        stmt = select(SymToken).filter_by(
            symbol=original_symbol, exchange=original_exchange
        )
        ...
        if db_record and db_record.brsymbol:
            ...
            logger.info(
                f"Using brsymbol from app.core.schemas: {original_symbol} -> {trading_symbol}"
            )
        else:
    ...
    try:
        ...
        for position in positions:
            try:
                ...
                # Retrieve broker symbol from app.core.schemas
