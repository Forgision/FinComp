...
from app.core.brokers.ibulls.database.master_contract_db import SymToken
from app.core.brokers.ibulls.baseurl import MARKET_DATA_URL
...
class BrokerData:
    ...
    async def _get_instrument_token(self, symbol: str, exchange: str) -> tuple:
        """
    ...
    async def get_quotes(self, symbol: str, exchange: str) -> dict:
        ...
        try:
            ...
            symbol_info, brexchange = await self._get_instrument_token(symbol, exchange)
