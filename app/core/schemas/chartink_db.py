...
class ChartinkStrategy(Base):
    ...
    # Relationships
    symbol_mappings: Mapped[List["ChartinkSymbolMapping"]] = relationship(
...
class ChartinkSymbolMapping(Base):
    ...
    strategy_id: Mapped[int] = mapped_column(
        Integer, ForeignKey("chartink_strategies.id"), nullable=False
    )
    ...
    # Relationships
    strategy: Mapped["ChartinkStrategy"] = relationship(
        "ChartinkStrategy", back_populates="symbol_mappings"
    )
