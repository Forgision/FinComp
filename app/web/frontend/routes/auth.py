...
from app.db.models.auth_db import auth_cache, feed_token_cache, upsert_auth
from app.db.models.settings_db import get_smtp_settings, set_smtp_settings
from app.db.models.user_db import (
    User,
    authenticate_user,
    find_user_by_email,
...
async def logout(request: Request, db = Depends(get_db)):
    if request.session.get('logged_in'):
        ...
        try:
            from app.db.models.master_contract_cache_hook import clear_cache_on_logout
