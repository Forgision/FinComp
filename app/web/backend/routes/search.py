...
async def token(
    request: Request, session_valid: bool = Depends(check_session_validity_fastapi)
):
...
async def search(
    ...
    if not query:
        ...
        return templates.TemplateResponse(
            "token.html",
            {"request": request, "error_message": "Please enter a search term."},
        )
    ...
    if not results:
        ...
        return templates.TemplateResponse(
            "token.html",
            {"request": request, "error_message": "No matching symbols found."},
        )
    ...
    return templates.TemplateResponse(
        "search.html", {"request": request, "results": results_dicts}
    )
