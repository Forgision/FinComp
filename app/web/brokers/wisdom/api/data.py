...
from app.broker.fivepaisaxts.database.master_contract_db import SymToken
...
class BrokerData:
    ...
    def get_market_depth(self, symbol: str, exchange: str) -> dict:
        ...
        try:
            ...
            if not user_id and hasattr(db, 'marketdata_userid') and db.get('marketdata_userid'):
            ...
            # Try to get from session if not found in instance
            if not feed_token and hasattr(db, 'marketdata_token') and db.get('marketdata_token'):
