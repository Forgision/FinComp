...
class MarketDataCache:
    ...
    def _merge_data(self, cached: Dict, new: Dict, token: str) -> Dict:
        ...
        # depth_prices = ['bp1', 'bp2', 'bp3', 'bp4', 'bp5', 'sp1', 'sp2', 'sp3', 'sp4', 'sp5'] # Unused
        # depth_quantities = ['bq1', 'bq2', 'bq3', 'bq4', 'bq5', 'sq1', 'sq2', 'sq3', 'sq4', 'sq5'] # Unused
        # depth_orders = ['bo1', 'bo2', 'bo3', 'bo4', 'bo5', 'so1', 'so2', 'so3', 'so4', 'so5'] # Unused
