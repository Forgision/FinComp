...
from app.db.models.sandbox_db import SandboxOrders, SandboxPositions, SandboxHoldings
            ...
            if price_type == 'MARKET':
                ...
                try:
                    ...
                    if quote and quote.get('ltp'):
                        ...
                        existing_position = db_session.query(SandboxPositions).filter_by(user_id=self.user_id, symbol=symbol, exchange=exchange, product=product).first()
