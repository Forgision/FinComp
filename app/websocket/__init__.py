...
from app.web.broker.compositedge.streaming.compositedge_adapter import (
    CompositedgeWebSocketAdapter,
)
from app.web.broker.definedge.streaming.definedge_adapter import (
    DefinedgeWebSocketAdapter,
)
from app.web.broker.dhan.streaming.dhan_adapter import DhanWebSocketAdapter
from app.web.broker.fivepaisaxts.streaming.fivepaisaxts_adapter import (
...
from app.web.websocket.broker_factory import register_adapter
