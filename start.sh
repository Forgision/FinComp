...
for dir in db log log/strategies strategies/scripts keys; do
...
echo "[OpenAlgo] Starting FastAPI application with uvicorn..."
exec /app/.venv/bin/uvicorn fastapi_app.main:app --host 0.0.0.0 --port 5000 --log-level warning